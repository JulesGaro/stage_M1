...
class GnomadConstraintAttributesModel(BaseModel):
    gene: str = Field(default=None)
...
class GnomadConstraintGeneModel(GeneModel):

    attributes: GnomadConstraintAttributesModel
